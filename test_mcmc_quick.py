"""Quick test: train 1K steps with fixed viewmat, export PLY, upload to gallery."""
import os, sys, time
...
OUTPUT = r"F:\Codebase\images_to_play\test_data\benchmark\mcmc\gaussian_splat_fixed.ply"

print("Starting quick 1K test...", flush=True)
start = time.time()
result = train_mcmc(
    WORK_DIR,
    total_steps=1000,
