"""Quick test v4: fixed init (opacity 0.1, random quats, knn scale)."""
import os, sys, time
...
OUTPUT = r"F:\Codebase\images_to_play\test_data\benchmark\mcmc\gaussian_splat_v4.ply"

print("Starting 1K test v4 (corrected init)...", flush=True)
start = time.time()
result = train_mcmc(
    WORK_DIR,
    total_steps=1000,
